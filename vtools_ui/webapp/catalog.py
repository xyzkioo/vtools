...
TOOLS: dict[str, dict] = {
    ...
    "transform": {
        ...
        "variants": {
            ...
            "kmodel": {"title": "PyTorch → K230", "script": "transform_tools/py2kmodel.py", "defaults": {"size": "320", "samples": "200"}, "fields": [("pt", "PyTorch 权重", "file", "--pt", True), ("onnx", "ONNX 输出", "save_file", "--onnx", False), ("kmodel", "kmodel 输出", "save_file", "--kmodel", False), ("calib", "校准图片目录", "dir", "--calib-dir", True), ("size", "输入尺寸", "number", "--size", False), ("samples", "校准样本数", "number", "--samples", False), ("rebuild", "覆盖已有产物", "bool", "--rebuild", False)]},
