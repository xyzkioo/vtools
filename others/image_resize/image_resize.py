...
def make_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--input", "-i", required=True, help="图片文件或目录")
    parser.add_argument("--output-dir", "-o", help="输出目录")
    parser.add_argument("--width", type=int, default=1024, help="目标宽度，默认 1024")
    parser.add_argument("--height", type=int, default=1024, help="目标高度，默认 1024")
    parser.add_argument("--mode", choices=["fit", "stretch", "crop"], default="fit", help="缩放方式，默认 fit")
    parser.add_argument("--recursive", action="store_true", help="递归处理子目录")
    parser.add_argument("--overwrite", action="store_true", help="覆盖已存在的输出文件")
    parser.add_argument("--output-format", choices=["same", "jpg", "png", "webp"], default="same", help="输出格式，默认 same")
