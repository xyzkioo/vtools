...
```bash
python others/video_frame_extractor/video_frame_extractor.py --help
python others/video_frame_extractor/video_frame_extractor.py --input /path/to/video.mp4 --output-dir /path/to/frames
```
...
```bash
python others/video_frame_extractor/video_frame_extractor.py \
