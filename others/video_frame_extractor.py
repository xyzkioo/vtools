...
PYCHARM_CONFIG: dict[str, Any] = {
    ...
    "start_frame": 0,
    "end_frame": None,  # 包含该帧；None=直到视频结束
    "recursive": False,
    "extension": ".jpg",
    "jpeg_quality": 95,
    "png_compression": 3,
...
def make_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--extension", help="输出格式：jpg、jpeg 或 png，默认 jpg")
    parser.add_argument("--jpeg-quality", type=int, help="JPEG 质量 0-100，默认 95")
    parser.add_argument("--png-compression", type=int, help="PNG 压缩级别 0-9，默认 3")
...
def main() -> int:
    ...
    for key, value in vars(args).items():
        # action='store_true' 的 False 表示命令行未传入，不能覆盖 PyCharm 配置。
